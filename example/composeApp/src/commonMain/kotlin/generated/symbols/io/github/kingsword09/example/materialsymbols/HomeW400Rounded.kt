...
public val MaterialSymbols.HomeW400Rounded: ImageVector
    get() {
        ...
        _homeW400Rounded = Builder(name = "HomeW400Rounded", defaultWidth = 48.0.dp, defaultHeight = 48.0.dp, viewportWidth = 960.0f, viewportHeight = 960.0f).apply {
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MaterialSymbols.HomeW400Rounded, contentDescription = "")
    }
}
