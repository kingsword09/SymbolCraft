...
public val Icons.PersonFilled: ImageVector
    get() {
        if (_personFilled != null) {
            return _personFilled!!
        }
        _personFilled = Builder(name = "PersonFilled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp, viewportWidth = 960.0f, viewportHeight = 960.0f).apply {
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons.PersonFilled, contentDescription = "")
    }
}
