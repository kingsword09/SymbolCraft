...
public val MaterialSymbols.SearchW500OutlinedFill: ImageVector
    get() {
        if (_searchW500OutlinedFill != null) {
            return _searchW500OutlinedFill!!
        }
        _searchW500OutlinedFill = Builder(name = "SearchW500OutlinedFill", defaultWidth = 48.0.dp,
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MaterialSymbols.SearchW500OutlinedFill, contentDescription = "")
    }
}
